...
from VIS.models.model import generate_model
...
#checkpoint = torch.load('VIS\weight\RGB_Kinetics_16f.pth')
checkpoint = torch.load('VIS\weight\RGB_Kinetics_16f.pth', map_location=torch.device('cpu'))
model.load_state_dict(checkpoint['state_dict'])
checkpoint = torch.load('VIS\weight\ckpt.pth', map_location=torch.device('cpu'))#model loading
