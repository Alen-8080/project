...
checkpoint = torch.load('C:\\Users\\jobya\\Documents\\vscode\\deeplearning\\Reimplementation\\Real-world-Anomaly-Detection-in-Surveillance-Videos-pytorch\\checkpoint\\ckpt.pth', map_location=torch.device('cpu'))
